...
function avanza_productos(){
    if (numObjeto_productos == largo_productos-1) {
        numObjeto_productos=0;
    } else{
        numObjeto_productos++;
    }      
    actualiza_productos();
...
function retrocede_productos(){
    if (numObjeto_productos == 0) {
        numObjeto_productos=largo_productos-1;
    } else{
        numObjeto_productos--;
    } 
    actualiza_productos();
...
function retrocede_diseno(){
    if (numObjeto_diseno == 0) {
        numObjeto_diseno=largo_diseno-1;
    } else{
        numObjeto_diseno--;
    } 
    actualiza_diseno();
...
function retrocede_estilo(){
    if (numObjeto_estilo == 0) {
        numObjeto_estilo=largo_estilo-1;
    } else{
        numObjeto_estilo--;
    } 
    actualiza_estilo();
...
document.getElementById("flecha2-dr-productos").addEventListener("click", avanza_productos);
document.getElementById("flecha1-dr-productos").addEventListener("click", avanza_productos);
document.getElementById("imagen-pequena-dr-productos").addEventListener("click", avanza_productos);

document.getElementById("flecha2-iz-productos").addEventListener("click", retrocede_productos);
document.getElementById("flecha1-iz-productos").addEventListener("click", retrocede_productos);
document.getElementById("imagen-pequena-iz-productos").addEventListener("click", retrocede_productos);


document.getElementById("flecha2-dr-diseno").addEventListener("click", avanza_diseno);
document.getElementById("flecha1-dr-diseno").addEventListener("click", avanza_diseno);
document.getElementById("imagen-pequena-dr-diseno").addEventListener("click", avanza_diseno);

document.getElementById("flecha2-iz-diseno").addEventListener("click", retrocede_diseno);
document.getElementById("flecha1-iz-diseno").addEventListener("click", retrocede_diseno);
document.getElementById("imagen-pequena-iz-diseno").addEventListener("click", retrocede_diseno);


document.getElementById("flecha2-dr-estilo").addEventListener("click", avanza_estilo);
document.getElementById("flecha1-dr-estilo").addEventListener("click", avanza_estilo);
document.getElementById("imagen-pequena-dr-estilo").addEventListener("click", avanza_estilo);

document.getElementById("flecha2-iz-estilo").addEventListener("click", retrocede_estilo);
document.getElementById("flecha1-iz-estilo").addEventListener("click", retrocede_estilo);
document.getElementById("imagen-pequena-iz-estilo").addEventListener("click", retrocede_estilo);
